    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonSnimiRezultat_Click(object sender, EventArgs e)
        {
            ...
            while (rdReport.Read())
            {
                ...
                stReader += "Izvodjac: " + rdReport.GetValue(1) + "   ";
                stReader += "Album: " + rdReport.GetValue(2) + "   ";
                string stPriv = rdReport.GetValue(4).ToString();
                int len = stPriv.Length;
                int end= len - 8;
                stPriv=stPriv.Substring(0, end);

                stReader += "Godina: " + stPriv + "   ";
                stReader += "Izdavac: " + rdReport.GetValue(5) + "   ";
                stReader += "\r\n";
                textBoxFajl.Text += stReader + "\r\n";
            }
            ...
            {//Snimi sadrzaj textBoxa u tekstualni fajl:
                ...
                sfd1.Title = "SNIMI REZULTAT PRETRAGE";
                ...
                if (sfd1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    File.WriteAllText(fileName, textBoxFajl.Text);
        ...
        private void buttonTabelarniPregled2_Click(object sender, EventArgs e)
        {
